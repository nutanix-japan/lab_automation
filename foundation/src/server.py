...
# params
HOST = os.environ['API_FOUNDATION_HOST']
PORT = int(os.environ['API_FOUNDATION_PORT'])
DEBUG = True
COMMAND = "python3 -u foundation.py -j '{}'"
...
@app.route('/api/public/foundation/v1/tasks/')
def handle_tasks():
    # clean up tasks
    now = int(time.time())
    del_uuids = []
...
@app.route('/api/public/foundation/v1/tasks/<task_uuid>')
